...
// The below script demonstrates how to verify the response returned from the server.

ResponseObject response = WS.sendRequest(findTestObject('Object Repository/New Request')) // Get the response object
